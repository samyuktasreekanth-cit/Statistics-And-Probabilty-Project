...
sheet1.cell_value(0, 1)

# MODIFIED ALGORITHM

# Displaying the data
# for i in range(sheet1.nrows):
#     print(str(sheet1.cell_value(i, 0)) + "\t\t\t\t" + str(sheet1.cell_value(i, 1)) + "\t\t\t\t" + str(sheet1.cell_value(i, 2)))

for i in range(1, sheet1.nrows):
    intital_algorithm1_values.append(sheet1.cell_value(i, 1))
for i in range(1, sheet1.nrows):
    initial_algorithm2_values.append(sheet1.cell_value(i, 2))
